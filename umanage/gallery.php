...
if(($postoptions['canupload']&$pauserinfo['postoptions'])==0)
	pa_exit("<b>你无权管理图片</b>");
if ($action==edit) {
...
if($_POST[action]==doupload){
    ...
    echo "<p align=center>[<a href=\"gallery3.php\">返回插入图片</a>] [<a href=\"gallery.php\">查看图库</a>] [<a href=\"gallery.php?action=upload\">继续上传图片</a>] </p>";
