...
if ($_GET[action]=="list") {
   ...
   $article = validate_articleid($comment[articleid]);
          echo "<tr class=".getrowbg().">
                     ...
                     <td><a target=_blank href=../index.php?mod=article&articleid=$comment[articleid]>$article[title]</td>
...
if ($_POST[action]=="removeallcomments") {
    ...
    $DB->query("DELETE FROM ".$db_prefix."message WHERE commentid IN ($commentids)");
