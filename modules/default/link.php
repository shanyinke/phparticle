...
redirect("./index2.php?mod=link&action=cache","友情链接已经更新,刷新缓冲中,请稍后......");
}
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
...
<td nowrap>
[<a href=\"./index2.php?mod=link&action=mod&id=$friendlink[id]\">编辑</a>]
[<a href=\"./index2.php?mod=link&action=kill&id=$friendlink[id]\">删除</a>]
</td>
</tr>";
}
echo "</table>";
...
redirect("./index2.php?mod=link&action=cache","友情链接已经删除,刷新缓冲中,请稍后......");
...
[<a href=\"./index2.php?mod=link&action=viewrequest&id=$friendlink[id]\">查看</a>]
</td>
<td nowrap align=center><font color=red>".show_state($friendlink[visible])."</font></td>
<td nowrap>
[<a href=\"./index2.php?mod=link&action=mod&id=$friendlink[id]\">编辑</a>]
[<a href=\"./index2.php?mod=link&action=kill&id=$friendlink[id]\">删除</a>]
[<a href=\"./index2.php?mod=link&action=pass&id=$friendlink[id]\">通过</a>]
[<a href=\"./index2.php?mod=link&action=deny&id=$friendlink[id]\">拒绝</a>]
</td>
</tr>";
}
echo "</table>";
...
redirect("./index2.php?mod=link&action=cache","友情链接一精审核通过,刷新缓冲中,请稍后......");
...
redirect("./index2.php?mod=link&action=validate","该友情链接已拒绝");
...
echo "</tr>\n";
echo "<tr class=".getrowbg().">";
echo "<td align=\"center\" nowrap><a href=\"./index2.php?mod=link&action=validate\">返回审批友链</a></td>";
echo "</tr>\n";
echo "</table>\n";
...
<a href='$img_link[siteurl]' title='站点名称:$img_link[sitename]
站点说明:$img_link[note]' target='_blank'>
...
";
	...
	if ($DB->num_rows($char_links)>0) {
      ...
      <div id='flinks'>
<!-- BEGIN char_linkbit -->
<a href='$char_link[siteurl]' title='站点说明:$char_link[note]' target='_blank' rel='external'>$char_link[sitename]</a>
<!-- END char_linkbit -->
	  </div>
";
	}
	...
	redirect("./index2.php?mod=link&action=edit","刷新缓冲完毕!");
}
function getstyle() {
