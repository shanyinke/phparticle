...
<?=$phparticletitle?> 注册条款
		...
		<div class="pagecontent">
					<div class="enter"> 
<textarea cols="90" rows="25" name="textarea" wrap="VIRTUAL" readonly>欢迎注册成为 <?=$phparticletitle?> 会员，注册表示您必须接受以下条款：
...
您只有无条件接受以上所有服务条款，才能继续申请
		...
		<input type="hidden" name="url" value="<?=$url?>">
           ...
           <input type="submit" class="buttot" name="agree" value=" 同意 ">
           <input type="submit" class="buttot" name="disagree" value="不同意">
		</div>
...
<div class="maincolumn">
		...
		<div class="pagelisttitlebg">
		<div class="pagelisttitlename">
你的位置：<a href="<?=$homepage?>/" class="classlinkclass">首页</a>&nbsp;>&nbsp;<a href="<?=$phparticleurl?>" class="classlinkclass"><?=$phparticletitle?></a>&nbsp;>&nbsp;注册成为会员
		</div>
		</div>
...
//-->
                    ...
                    <input type="submit" value="提交申请" class="buttot" name="submit">
                    <input type="reset" value="重置表单" class="buttot" name="reset">
                </div>
</fieldset>
