...
this.btnList = {
    ...
    "bold":           ['Bold',                 '粗体',               'editor_action(this.id)',  'ed_format_bold.gif'],
    ...
    "strikethrough":  ['StrikeThrough',        '删除线',             'editor_action(this.id)',  'ed_format_strike.gif'],
    "subscript":      ['SubScript',            '上标',               'editor_action(this.id)',  'ed_format_sub.gif'],
    "superscript":    ['SuperScript',          '上标',               'editor_action(this.id)',  'ed_format_sup.gif'],
    "justifyleft":    ['JustifyLeft',          '左对齐',             'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        '居中',               'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         '右对齐',             'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    '项目列表',           'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  '数目列表',           'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              '文本左缩进',         'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               '文本缩进',           'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            '文本颜色',           'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            '背景色',             'editor_action(this.id)',  'ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', '插入水平条',         'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           '插入超链接',         'editor_action(this.id)',  'ed_link.gif'],
    "insertimage":    ['InsertImage',          '插入图片,带图库预览','editor_action(this.id)',  'ed_image.gif'],
    "insertimage3":   ['InsertImage3',          '插入图片,带图库预览','editor_action(this.id)',  'ed_image.gif'],
    "insertimage2":   ['InsertImage2',         '插入图片',           'editor_action(this.id)',  'ed_image.gif'],
    "inserttable":    ['InsertTable',          '插入表格',           'editor_action(this.id)',  'insert_table.gif'],
    "htmlmode":       ['HtmlMode',             '查看 Html 源代码',   'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          '最大化编辑器',       'editor_action(this.id)',  'fullscreen_maximize.gif'],
    "about":          ['about',                '关于',  'editor_about(\''+objname+'\')',  'ed_about.gif'],
   ...
   // end: custom buttons
    "word":           ['word',                 '清除 MS-WORD 标记" ','editor_action(this.id)','ed_word.gif'],
    "help":           ['showhelp',             '使用帮助',  'editor_action(this.id)',  'ed_help.gif']};
...
function editor_action(button_id) {
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    else if (cmdID.toLowerCase() == 'insertimage3'){
      showModalDialog(_editor_url + "popups/insert_image3.html", editdoc, "resizable: no; help: no; status: no; scroll: yes; ");
    }
